    ...
    <header class="header">
        <div class="container">
            <div @click="$router.push('/')" class="header__logo">
                <img src="../assets/artgalery.svg" alt="logo">
            </div>
            <div class="header__favorites favorites">
                ...
                <div class="favorites__text">Избранное</div>
            </div>
        </div>
    </header>
</template>
...
.favorites__img svg path, .favorites__text {
    transition: all .2s ease;
}
.favorites:hover .favorites__img svg path, .favorites:hover .favorites__text{
    fill: #FFF200;
    color: #FFF200;
}
